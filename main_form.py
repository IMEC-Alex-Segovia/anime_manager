...
class MainForm:
    ...
    def _setup_ui(self):
        ...
        self.anime_list_tree.column(self.COLUMNS[0], width=310)
        self.anime_list_tree.column(self.COLUMNS[1], width=100)
        self.anime_list_tree.column(self.COLUMNS[2], width=130)
        self.anime_list_tree.column(self.COLUMNS[3], width=130)
        self.anime_list_tree.column(self.COLUMNS[4], width=130)
        # === BUTTONS ===
